...
db = dataset.connect('sqlite:///mac.db')
conn = sqlite.connect('mac.db')
...
def scrape_missed_connections():
    ...
    response = requests.get(BASE_URL + "search/sss?query=macbook+pro+15+-13+retina&minAsk=200&maxAsk=2000&sort=rel&srchType=T")
