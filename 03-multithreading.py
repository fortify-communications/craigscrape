...
db = dataset.connect('sqlite:///carpurchase_bmw.db')
...
def scrape_missed_connections():
    ...
    response = requests.get(BASE_URL + "search/sss?query=bmw+328%7C528+%282013%7C2012%7C2011%29&minAsk=10000&maxAsk=35000&sort=rel&srchType=T&excats=69-91")
